    ...
    public SwerveDriveSubsystem() {
        ...
        if (Robot.PRACTICE_BOT) {
            mSwerveModules = new SwerveDriveModule[] {
                    new SwerveDriveModule(0, new VictorSPX(3), new VictorSPX(4), 255.5859),
                    new SwerveDriveModule(1, new VictorSPX(6), new VictorSPX(5), 338.906),
                    new SwerveDriveModule(2, new VictorSPX(2), new VictorSPX(1), 13.359),
                    new SwerveDriveModule(3, new VictorSPX(7), new VictorSPX(8), 15.82),
            };
            ...
            mSwerveModules = new SwerveDriveModule[] {
                    new SwerveDriveModule(0,
                            new VictorSPX(DRIVETRAIN_FRONT_LEFT_ANGLE_MOTOR),
                            new VictorSPX(DRIVETRAIN_FRONT_LEFT_DRIVE_MOTOR),
                            87.890),
                    new SwerveDriveModule(1,
                            new VictorSPX(DRIVETRAIN_FRONT_RIGHT_ANGLE_MOTOR),
                            new VictorSPX(DRIVETRAIN_FRONT_RIGHT_DRIVE_MOTOR),
                            235.195),
                    new SwerveDriveModule(2,
                            new VictorSPX(DRIVETRAIN_BACK_RIGHT_ANGLE_MOTOR),
                            new VictorSPX(DRIVETRAIN_BACK_RIGHT_DRIVE_MOTOR),
                            320.976),
                    new SwerveDriveModule(3,
                            new VictorSPX(DRIVETRAIn_BACK_LEFT_ANGLE_MOTOR),
                            new VictorSPX(DRIVETRAIN_BACK_LEFT_DRIVE_MOTOR),
                            245.742),
            };
