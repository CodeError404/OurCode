...
public class SwerveDriveModule extends Subsystem {
    ...
    private final VictorSPX mAngleMotor;
    private final VictorSPX mDriveMotor;
    ...
    public SwerveDriveModule(int moduleNumber, VictorSPX angleMotor, VictorSPX driveMotor, double zeroOffset) {
    ...
    public VictorSPX getAngleMotor() {
        return mAngleMotor;
    }
    ...
    public VictorSPX getDriveMotor() {
        return mDriveMotor;
    }
